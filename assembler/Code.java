...
public class Code {
	private static final HashMap<String, String> compTable = new HashMap<String, String>();
	private static final HashMap<String, String> destTable = new HashMap<String, String>();
	private static final HashMap<String, String> jumpTable = new HashMap<String, String>();
